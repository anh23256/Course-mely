...
<head>
    ...
    <title>Thông Báo Thay Đổi Vai Trò - CourseMeLy</title>
    <style>
                    ...
                    <tr>
                        <td align="center" style="padding:40px 30px 20px;">
                            ...
                            <p style="color:#555; font-size:16px; line-height:1.6; margin-top:16px; text-align: center;">
                                Vai trò hiện tại của bạn là: <strong style="color:#E27447;">{{ $currencyRole }}</strong><br>
                                Vai trò mới của bạn trên nền tảng CourseMeLy là: <strong style="color:#E27447;">{{ $newRole }}</strong>.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 30px 30px;">
                            <div style="background: linear-gradient(to bottom right, #fff8f5, #ffefe9); border-radius:14px; padding:25px 20px; text-align:center; box-shadow: 0 8px 15px rgba(226,116,71,0.08);">
                                ...
                                <a href="{{ config('app.fe_url') . '/user-profile' }}"
