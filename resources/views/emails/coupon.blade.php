...
<head>
    ...
    <title>Mã Giảm Giá Đặc Biệt - CourseMeLy</title>
    <style>
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <p
                                ...
                                Ưu Đãi Đặc Biệt Chỉ Dành Cho Bạn</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding:40px 30px 20px;">
                            ...
                            <p
                                ...
                                <strong style="color:#E27447;">Nhận ngay mã giảm giá độc quyền</strong>
                                để tiết kiệm chi phí học tập.
                            </p>
                        </td>
                    </tr>
                        ...
                        <td style="padding:0 30px 30px;">
                            <div
                                ...
                                <p style="font-size:18px; color:#E27447; font-weight:600; margin-bottom:20px;">
                                    🎉 Mã Giảm Giá Của Bạn 🎉</p>

                                <div
                                    style="background-color:white; border-radius:10px; padding:20px; margin-bottom:20px; box-shadow:0 6px 15px rgba(226,116,71,0.1);">
                                    <p style="margin:0; font-size:14px; color:#666; margin-bottom:10px;">Mã Giảm Giá:
                                    </p>
                                    <div
                                        style="display:inline-block; background-color:#f0f0f0; border-radius:8px; padding:12px 20px; border:2px dashed #E27447;">
                                        <span
                                            style="font-size:24px; font-weight:700; color:#E27447; letter-spacing:2px;">
                                            {{ $discount->code }}
                                        </span>
                                    </div>
                                </div>

                                <a href="{{ config('app.fe_url') . '/my-courses?tab=coupon' }}"
                        ...
                        <td align="center" style="padding:5px 30px 30px;">
                            <div style="border-top:1px solid #eee; padding-top:20px; max-width: 90%; margin: 0 auto;">
                                <p style="font-size:15px; color:#555; line-height: 1.6; text-align: center;">
                                    Đừng bỏ lỡ cơ hội này! Mã giảm giá có hạn và chỉ áp dụng cho một số khóa học nhất
                                    định.
                                    Nhanh tay sử dụng để tiết kiệm chi phí và nâng cao kỹ năng của bạn.
                                </p>
                            </div>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="font-size:14px; color:#777; margin:0 0 5px;">
                                            &copy; 2025 CourseMeLy. Mọi quyền được bảo lưu.
                                        </p>
