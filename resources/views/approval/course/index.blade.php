                    ...
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="card text-center shadow-sm border-0 hover-effect">
                            <div class="card-body">
                                ...
                                <p class="card-text fs-4 fw-bold text-success">{{ $approvalCount->approved_approval ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="card text-center shadow-sm border-0 hover-effect">
                            <div class="card-body">
                                ...
                                <p class="card-text fs-4 fw-bold text-warning">{{ $approvalCount->pending_approval ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-3">
                        <div class="card text-center shadow-sm border-0 hover-effect">
                            <div class="card-body">
                                ...
                                <p class="card-text fs-4 fw-bold text-danger">{{ $approvalCount->rejected_approval ?? 0 }}
                                </p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <form>
                                            <div class="container">
                                                ...
                                                <div class="row">
                                                    <li class="col-6">
                                                        <div class="mb-2">
                                                            <label for="approval_start_date" class="form-label">Ngày bắt
                                                                đầu
                                                                kiểm duyệt</label>
                                                            <input type="date" class="form-control form-control-sm"
                                                    ...
                                                    <li class="col-6">
                                                        <div class="mb-2">
                                                            <label for="approval_end_date" class="form-label">Ngày kết
                                                                thúc
                                                                kiểm duyệt</label>
                                                            <input type="date" class="form-control form-control-sm"
                            ...
                            <form>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control form-control-sm" name="user_name_approved"
                                        ...
                                        <tbody class="list">
                                            @foreach ($approvals as $approval)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @elseif($approval->status == 'modify_request')
                                                            <span class="badge bg-info text-white"><i
                                                                    class="bx bx-edit"></i> Sửa đổi nội dung</span>
                                                        @else
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ route('admin.approvals.courses.show', $approval->id) }}">
